...
* Enhances Ruby Mode defines its own specific faces with the hook <tt>erm-define-faces</tt>. If your theme is already defining that faces, to not overwrite them, just remove the hook with:
