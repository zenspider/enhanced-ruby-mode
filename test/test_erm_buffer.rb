...
D
  ...
  def test_heredoc_nesting
    assert_equal "((27 1 27 l 10 r 19)(0 1 2 6 7 15 16)(1 7 9 20 21)(3 9 11 19 20)(11 3 6 11 15 16 19 21 23)(12 2 3))",
     parse_text(%q{a=<<E
a
#{<<EE
EE
...
E
  ...
  def test_heredoc_nesting_and_quoting
    assert_equal "((62 1 62 l 22 r 38)(0 1 3 4 5 8 9 15 16 18 19 23 24 27 28 59 62)(1 19 21 28 36 39 42 44 54)(3 21 23 38 39)(5 16 18)(11 5 8 9 15 24 27 36 38 42 44 54 59)(12 3 4))",
     parse_text(%q{
a= <<E,<<-'D',:b
se#{
<<E
